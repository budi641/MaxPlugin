...
public:
	...
	void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_RB_BEND_OSM_CLASS) : _T("BendPB2_OSM"); }
	...
	const TCHAR* GetObjectName(bool localized) const override { return localized ? GetString(IDS_RB_BEND2) : _T("BendPB2"); }
...
public:
	...
	// non-localized class name used for scripting
	const TCHAR* NonLocalizedClassName() { return _T("BendPB2_OSM"); }
...
public:
	...
	const TCHAR* NonLocalizedClassName() { return _T("BendPB2_WSM"); }
	SClass_ID		SuperClassID() { return WSM_OBJECT_CLASS_ID; }
	Class_ID		ClassID() { return BENDWSM_CID; }
...
static bendPBAccessor   MybendPBAccessor;
